class Game {
  ...
  start() {
    ...
    rocket1.addImage("car1", rocket1_img);
    rocket1.scale = 0.3;

    rocket1.addImage("blast", blastImage); //C42 //SA

    rocket2 = createSprite(width / 2 + 100, height - 100);
    rocket2.addImage("car2", rocket2_img);
    rocket2.scale = 0.3;

    rocket2.addImage("blast", blastImage); //C42//SA

    cars = [rocket1, rocket2];
    ...
    this.addSprites(powerCoins, 18, powerCoinImage, 0.1);
